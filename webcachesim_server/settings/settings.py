"""
Django settings for webcachesim_manager project.
...
SECRET_KEY = 'zx7p46q12%!=*wsxrxl0ys^sf28yy44u42shq!^wnq$o49t)xv'
...
# config settings
config_dir = '../task_config_dir/'
ALGORITHM_PARAM_FILE = config_dir + "algorithm_params.yaml"
